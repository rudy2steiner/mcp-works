...
1. **Platform Rights**: The mcpworks.com platform, including its interface, features, and functionality, is protected under copyright law. mcpworks.com retains all rights to the platform infrastructure.

2. **User Content**: You retain your rights to any MCP servers you publish. By publishing, you grant mcpworks.com a license to host and distribute your content through our platform.
...
- Support is available via support@mcpworks.com
...
THE SERVICE IS PROVIDED "AS IS" WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES. mcpworks.com DISCLAIMS ALL WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.

## Limitation of Liability

TO THE MAXIMUM EXTENT PERMITTED BY LAW, mcpworks.com SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR PUNITIVE DAMAGES ARISING FROM YOUR USE OF THE SERVICE OR ANY MCP SERVERS PUBLISHED THROUGH THE SERVICE.
...
These terms shall be governed by and construed in accordance with the laws of the jurisdiction where mcpworks.com operates, without regard to conflict of law principles.

## Contact Information

For questions about these terms, please contact us at [support@mcpworks.com](mailto:support@mcpworks.com).

---

By using mcpworks.com, you acknowledge that you have read and agree to these Terms of Service.
`;
